/* ==========================================================================
   ...
   recent-winners.js — Infinite-looping swipe/scroll-snap carousel with dot
   pagination. Vanilla JS, no dependencies, scoped entirely to
   [data-rw-carousel] / [data-rw-track] / [data-rw-dots].
...
(function () {
  ...
  const realSlides = Array.from(track.querySelectorAll(".rw-slide"));
  ...
  function getSlides() {
    return Array.from(track.querySelectorAll(".rw-slide"));
  }
